...
import Recent1 from "../../../public/images/blogpage/recent1.jpg";
import Recent2 from "../../../public/images/blogpage/recent2.jpg";
import Recent3 from "../../../public/images/blogpage/recent3.jpg";
import Recent4 from "../../../public/images/blogpage/recent4.jpg";
import Recent5 from "../../../public/images/blogpage/recent5.jpg";
import Recent6 from "../../../public/images/blogpage/recent6.jpg";
          ...
          <div className="flex flex-col bg-[#f8f8f8] my-[35px] p-[30px]">
            ...
            <div className="flex flex-col gap-7">
              ...
              <div className="flex gap-8">
                <Image src={Recent1} alt="recent_img" className="w-[10rem]" />
              ...
              {/*  */}
              <div className="flex gap-8">
                <Image src={Recent2} alt="recent_img" className="w-[10rem]" />
                <div className="flex flex-col gap-4 justify-center">
                  <p className="text-[14px] text-[#646464] font-medium">
                    March 22, 2022
                  </p>
              ...
              {/*  */}
              <div className="flex gap-8">
                <Image src={Recent3} alt="recent_img" className="w-[10rem]" />
                <div className="flex flex-col gap-4 justify-center">
                  <p className="text-[14px] text-[#646464] font-medium">
                    March 22, 2022
                  </p>
              ...
              {/*  */}
              <div className="flex gap-8">
                <Image src={Recent4} alt="recent_img" className="w-[10rem]" />
                <div className="flex flex-col gap-4 justify-center">
                  <p className="text-[14px] text-[#646464] font-medium">
                    March 22, 2022
                  </p>
              ...
              {/*  */}
              <div className="flex gap-8">
                <Image src={Recent5} alt="recent_img" className="w-[10rem]" />
                <div className="flex flex-col gap-4 justify-center">
                  <p className="text-[14px] text-[#646464] font-medium">
                    March 22, 2022
                  </p>
              ...
              {/*  */}
              <div className="flex gap-8">
                <Image src={Recent6} alt="recent_img" className="w-[10rem]" />
                <div className="flex flex-col gap-4 justify-center">
                  <p className="text-[14px] text-[#646464] font-medium">
                    March 22, 2022
                  </p>
