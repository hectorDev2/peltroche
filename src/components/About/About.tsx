    ...
    <>
      <section className="flex flex-col justify-between gap-2 about-section pb-[20rem]">
        <div className="container page-padding">
          {/* text-img div */}
          <div className="grid md:grid-cols-[1fr_1fr] h-[60rem] grid-cols-1">
            {/* title div -- */}
            <div className="flex flex-col md:!text-left relative  justify-center items-center !text-center">
              <h2 className="text-[#FF1803] relative z-10 text-[15px] uppercase font-bold mt-10 md:ml-20 ml-3 ">
                quienes somos
              </h2>
